...
namespace ProjektFilmy
{
    class Program
    {
        ...
        public static void Proba()
        {
            ...
            #endregion
            // Tworzenie instancji wypożyczalni
            Wypozyczalnia wypozyczalnia = new("Super Wypożyczalnia");
            ...
            Profil p1 = new("AgataNowak55");
            // test metod dla uzytkownika
            ...
            WypozyczalniaProfil container = new(wypozyczalnia, p1);


            // proba losowania filmów
            try
            {
                Film losowyFilm = wypozyczalnia.LosujFilm();
                Console.WriteLine($"Wylosowany film: {losowyFilm}");
            }
            ...
            // serializacja
            wypozyczalnia.ZapiszXml1("wyp.xml");
            container.ZapiszXml("kontener.xml");
